...
All model fitting is done with ['EzTaoX'](https://github.com/LSST-AGN-Variability/EzTaoX) (Yu et al. 2025), a JAX-based gaussian process framework built on tinygp, with posterior sampling done with numpyro's No-U-Turn Sampler, known as NUTS.
...
See attached .bib file for associated literature.
